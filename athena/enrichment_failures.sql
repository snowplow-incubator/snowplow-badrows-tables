CREATE EXTERNAL TABLE IF NOT EXISTS {{ DATABASE }}.enrichment_failures (
  schema string,
  data struct<
    failure: struct<
      timestamp: STRING,
...
STORED AS TEXTFILE
LOCATION 's3://{{ BUCKET }}/{{ PIPELINE }}/partitioned/com.snowplowanalytics.snowplow.badrows.enrichment_failures'
