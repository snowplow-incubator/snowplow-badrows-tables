CREATE EXTERNAL TABLE IF NOT EXISTS {{ DATABASE }}.loader_runtime_error (
  schema string,
  data struct<
    payload: struct<
      app_id: STRING,
...
STORED AS TEXTFILE
LOCATION 's3://{{ BUCKET }}/{{ PIPELINE }}/partitioned/com.snowplowanalytics.snowplow.badrows.loader_runtime_error'
