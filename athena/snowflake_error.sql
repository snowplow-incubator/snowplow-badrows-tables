CREATE EXTERNAL TABLE IF NOT EXISTS {{ DATABASE }}.snowflake_error (
  schema string,
  data struct<
...
STORED AS TEXTFILE
LOCATION 's3://{{ BUCKET }}/{{ PIPELINE }}/partitioned/com.snowplowanalytics.snowplow.badrows.snowflake_error'
